...
game: build/main.o build/utils/colors.o build/utils/input.o build/scenes/game.o
	gcc build/main.o build/utils/colors.o build/utils/input.o build/scenes/game.o -o build/game.exe -Llib -lraylib -lwinmm -lgdi32

build/main.o: src/main.asm include/raylib.asm
	nasm src/main.asm -o build/main.o -fwin64

build/utils/colors.o: src/utils/colors.asm include/colors.asm
	nasm src/utils/colors.asm -o build/utils/colors.o -fwin64
